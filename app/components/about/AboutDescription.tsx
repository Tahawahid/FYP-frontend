  ...
  return (
    <div className="max-w-3xl mx-auto mb-16 text-center">
      <p className="text-lg text-brand-primary-700 leading-relaxed">
        ...
        recommends personalized learning paths, tracks your progress, and helps optimize your resume 
        to match industry demands. With SkillSync, stay ahead in your career journey with data-driven insights.
      </p>
    </div>
  );
}
