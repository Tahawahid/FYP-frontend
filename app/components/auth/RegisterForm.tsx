    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="flex items-start">
        <input
          ...
          type="checkbox"
          required
          className="h-4 w-4 text-brand-primary-600 focus:ring-brand-primary-500 border-gray-300 rounded mt-1"
        />
        <label htmlFor="terms" className="ml-2 block text-sm text-gray-600">
          I agree to the{" "}
          <a href="/terms" className="text-brand-primary-600 hover:text-brand-primary-500">
            Terms of Service
          </a>{" "}
          and{" "}
          <a href="/privacy" className="text-brand-primary-600 hover:text-brand-primary-500">
            Privacy Policy
          </a>
        </label>
      </div>
